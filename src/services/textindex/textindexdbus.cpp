...
void TextIndexDBusPrivate::handleConfigChanged()
{
    ...
    m_currentSupportedExtensions.toSet();
    const QSet<QString> currentExtensionsSet(m_currentSupportedExtensions.toSet());
    const QSet<QString> newExtensionsSet(newSupportedExtensions.toSet());
