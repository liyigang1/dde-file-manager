...
public:
    ...
    static inline QByteArray normalizePath(const QString &path)
    {
    ...
    static inline QByteArray normalizePath(const QByteArray &path)
    {
...
private:
    ...
    struct ScanState
    {
        ...
        // Normalized UTF-8 paths, matched exactly before descending.
...
{
    qint64 currentSize = state.result.progressSize;
