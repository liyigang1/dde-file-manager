...
static constexpr char kOpticalShareObjPath[] { "/com/deepin/filemanager/daemon/OpticalShare" };

OpticalShareDBus::OpticalShareDBus(QObject *parent)
    : QObject(parent), QDBusContext()
{
    fmInfo() << "OpticalShareDBus: initializing service";
    QDBusConnection::systemBus().registerObject(kOpticalShareObjPath, this, QDBusConnection::ExportAdaptors);
