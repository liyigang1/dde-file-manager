...
void Computer::followEvents()
{
    ...
    dpfHookSequence->follow("dfmplugin_propertydialog", "hook_PropertyDialog_Disable", ComputerEventReceiver::instance(), &ComputerEventReceiver::handlePropertydialogDisable);
}
