...
Q_SIGNALS:
    void progressChanged(TEXTINDEX_CREATOR_NAMESPACE::IndexTask::Type type, qint64 count, qint64 total);
    void finished(TEXTINDEX_CREATOR_NAMESPACE::IndexTask::Type type, TEXTINDEX_CREATOR_NAMESPACE::HandlerResult result);
...
Q_DECLARE_METATYPE(TEXTINDEX_CREATOR_NAMESPACE::IndexTask::Type)
